...
at the canopy level of forests. Although major drawbacks of that type
of lidar includes the inability to reliably reach the lower part of
the forest while also not being able to really capture the fine
details of such complex environment. This is explained by the
occulusion caused by top part of the canopy and the fact that the high
alitudes causes high beam divergence.
